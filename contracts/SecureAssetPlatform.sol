 ...
 * @dev Stores fixed-size hashes/references on-chain. Uses OpenZeppelin AccessControlDefaultAdminRules for 2-step admin transfer.
 */
contract SecureAssetPlatform is ERC721, AccessControlDefaultAdminRules, Pausable {
    ...
    constructor(address rootAdmin)
        ERC721("BEL Digital Asset Ledger", "BEL-DAM")
        AccessControlDefaultAdminRules(0, rootAdmin)
    {
