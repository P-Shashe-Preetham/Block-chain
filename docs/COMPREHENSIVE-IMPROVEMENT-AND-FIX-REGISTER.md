...
| QA-04 | Add API contract, authentication, authorization, replay, idempotency, and transaction-state tests. | P0 | FastAPI boundary, explicit-settings HTTPX tests, transaction state-machine tests, and CI report; business API/provider tests remain pending. |
