...
_SPECS = (
    ...
    _EventSpec("DefaultAdminDelayChangeCanceled", "0x2b1fa2edafe6f7b9e97c1a9e0c3660e645beb2dcaa2d45bdbf9beaf5472e1ec5", ()),
    _EventSpec("DefaultAdminDelayChangeScheduled", "0xf1038c18cf84a56e432fdbfaf746924b7ea511dfe03a6506a0ceba4888788d9b", (
        _Field("newDelay", "uint48", False), _Field("effectSchedule", "uint48", False),
    )),
    _EventSpec("DefaultAdminTransferCanceled", "0x8886ebfc4259abdbc16601dd8fb5678e54878f47b3c34836cfc51154a9605109", ()),
    _EventSpec("DefaultAdminTransferScheduled", "0x3377dc44241e779dd06afab5b788a35ca5f3b778836e2990bdb26a2a4b2e5ed6", (
        _Field("newAdmin", "address", True), _Field("acceptSchedule", "uint48", False),
    )),
...
def _decode_word(value: str, abi_type: str) -> str:
    ...
    if abi_type == "uint48" and number > 0xFFFFFFFFFFFF:
        raise AbiDecodeError("uint48 value overflows")
    if abi_type == "uint64" and number > 0xFFFFFFFFFFFFFFFF:
        raise AbiDecodeError("uint64 value overflows")
    if abi_type in {"uint8", "uint48", "uint64", "uint256"}:
        return str(number)
